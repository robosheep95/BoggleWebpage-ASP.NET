    ...
    <div class="jumbotron">
        ...
        <h3>Layout of Data Objects</h3>
            <asp:Table ID="Table1" runat="server" Width="424px">
                ...
                <asp:TableRow><asp:TableCell ColumnSpan="3">Game Window</asp:TableCell></asp:TableRow>
                <asp:TableRow><asp:TableCell ColumnSpan="3">Game Logic</asp:TableCell></asp:TableRow>
                <asp:TableRow><asp:TableCell>Board</asp:TableCell><asp:TableCell>Player</asp:TableCell><asp:TableCell>Word List</asp:TableCell></asp:TableRow>
                <asp:TableRow><asp:TableCell>Dice</asp:TableCell></asp:TableRow>
            </asp:Table>
